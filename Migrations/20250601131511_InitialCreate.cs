        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImage = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    FaceEncodingData = table.Column<string>(type: "LONGTEXT", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceStatus = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false, defaultValue: "Absent")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DetectionMethod = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false, defaultValue: "Manual")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Notes = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseAssignments_ProfessorId_SubjectId_Section_AcademicYear~",
                table: "CourseAssignments",
                columns: new[] { "ProfessorId", "SubjectId", "Section", "AcademicYear", "Semester" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_CourseAssignmentId_SessionDate",
                table: "Sessions",
                columns: new[] { "CourseAssignmentId", "SessionDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Students_Stage_StudyType_Section",
                table: "Students",
                columns: new[] { "Stage", "StudyType", "Section" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_Stage_StudyType",
                table: "Subjects",
                columns: new[] { "Stage", "StudyType" });
